...
from models import db, AcadUser
from werkzeug.security import generate_password_hash
from flask import jsonify
from routes.admin import admin_bp  # make sure your admin blueprint is correct
...
def login():
    ...
    if 'user_id' in session:
        ...
        elif role == 'Registrar': # Handle Registrar role redirection
    ...
    if request.method == 'POST':
        ...
        if user and user.check_password(password):
            ...
            if user.role == 'admin':
                return redirect('/NovaSight/admin')
            elif user.role == 'Registrar': # Handle Registrar role login
                return redirect('/NovaSight/registrar/home')
            elif user.role == 'SASO':
                return redirect('/NovaSight/saso/home')
